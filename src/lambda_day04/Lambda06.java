...
public class Lambda06 {
    public static void main(String[] args) {
        ...
        UniversiteLambda6 ingilizceBolum=new UniversiteLambda6("IngilizDil", "Ingilizce", 93, 154);
        ...
        System.out.println(uniList.stream().anyMatch(t -> t.getBolum().equals("Matem")));// true
        ...
        //ciktisi: Optional[UniversiteLambda6{fakulte='IIBF', bolum='Iktisat', notOrtalama=98, ogrenciNo=134}]
        ...
        // ciktisi: [UniversiteLambda6{fakulte='FenEdebiyat', bolum='Matematik', notOrtalama=95, ogrenciNo=142}, UniversiteLambda6{fakulte='FenEdebiyat', bolum='Edebiyat', notOrtalama=97, ogrenciNo=123}, UniversiteLambda6{fakulte='IIBF', bolum='Iktisat', notOrtalama=98, ogrenciNo=134}]
